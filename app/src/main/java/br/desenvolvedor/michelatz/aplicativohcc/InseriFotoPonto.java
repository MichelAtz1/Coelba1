...
public class InseriFotoPonto extends AppCompatActivity {

    private static final int REQUEST_CAMERA_PERMISSION = 200;

    Uri outputUri;
    File fileFinal;
    private String imgString, idPoste, valorPagina = "0", caminhoImagem = "inicial";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inseri_foto_ponto);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        toolbar.setTitle("Aplicativo HCC");
        toolbar.setSubtitle("Imagem do Ponto");
    ...
    public void inseriImagem(View v) {
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(InseriFotoPonto.this, new String[]{Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE}, REQUEST_CAMERA_PERMISSION);
            return;
        }
        ...
        switch (requestCode) {
            case REQUEST_CAMERA_PERMISSION: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(InseriFotoPonto.this, "Desculpe!!! você não pode usar este aplicativo sem conceder permissão!", Toast.LENGTH_LONG).show();
                    finish();
                }
            }
        }
    ...
    private Uri getTempCameraUri() {
        try {
            ...
            Uri photoURI2 = FileProvider.getUriForFile(InseriFotoPonto.this,
    ...
    public void onBackPressed() {
        ...
        alertDialogBuilder.setMessage("Tem certeza que deseja sair desta aba?");
        ...
        alertDialogBuilder.setPositiveButton("Sim",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        Intent intent = new Intent(InseriFotoPonto.this, GerenciarLocacoes.class);
                        InseriFotoPonto.this.startActivity(intent);
                        finish();
                        InseriFotoPonto.super.onBackPressed();
                    }
                });
