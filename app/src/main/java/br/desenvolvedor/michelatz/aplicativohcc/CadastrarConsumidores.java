...
public class CadastrarConsumidores extends AppCompatActivity {
    ...
    private String tipoEquipamento, numeroPlacaEquipamento, tensao, descricao, idConsumidor, idLocacao, idPoste, cia, potencia;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getStringExtra("USERTELA") != null) {
            ...
            cia = bundle.getString("cia");
            potencia = bundle.getString("potencia");
