...
import br.desenvolvedor.michelatz.aplicativohcc.Adapter.AdapterListViewPostesComEditaExclui;
...
public class GerenciarLocacoes extends AppCompatActivity
    ...
    private AdapterListViewPostesComEditaExclui adapterListViewPostesComEditaExclui;
        ...
        spnLocacoesAbertas.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (previa.equals("Selecione")) {
                    ...
                    editor.putString("numeroCheck", "0");
                    editor.commit();
    ...
    private void inflaListaPostes() {
        ...
        db = openOrCreateDatabase(BANCO, Context.MODE_PRIVATE, null);
        Cursor linhas = db.rawQuery("SELECT * FROM " + TABELAPOSTE + " WHERE IDLOCACAO = " + idLocacao + " order by ID desc;", null);
        int totalDB = linhas.getCount();
        Log.d("teste", "Contador Banco de dados: "+totalDB);
        //int contador = 1;
        ...
        adapterListViewPostesComEditaExclui = new AdapterListViewPostesComEditaExclui(this, itens);
        listViewPostes.setAdapter(adapterListViewPostesComEditaExclui);
        ...
        dialogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (descricaoPonto.equals("")) {
                    ...
                    inserirEquipamento(retorno,descricaoPonto);
                    dialog.dismiss();
                    confirmarInsercaoFoto(retorno);
                }
            }
        });
    ...
    public void editarItem(View v) {
        adapterListViewPostesComEditaExclui.editaItemPoste((Integer) v.getTag());
        String idMensagem = adapterListViewPostesComEditaExclui.idSelecionado;
        editarPoste(idMensagem);
    }

    public void deletaItemPoste(View v) {
        adapterListViewPostesComEditaExclui.removeItemPoste((Integer) v.getTag());
        String idMensagem = adapterListViewPostesComEditaExclui.idSelecionado;
        confirmarDeletePoste(idMensagem);
    }
        ...
        dialogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (descricaoEstru.equals("")) {
                    ...
                    dialog.dismiss();
                    confirmarInsercaoFoto(idMensagemteste);
                }
            }
        });
    ...
    private void confirmarInsercaoFoto(final String idMensagem) {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(this);
        alertDialogBuilder.setMessage("Deseja adicionar uma foto deste Ponto?");
        ...
        alertDialogBuilder.setPositiveButton("Sim",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        SharedPreferences sharedpreferences = getSharedPreferences(Login.MyPREFERENCES, Context.MODE_PRIVATE);
                        SharedPreferences.Editor editor = sharedpreferences.edit();
                        editor.putString("idPosteKey", idMensagem);
                        editor.commit();
                        Intent intent = new Intent(GerenciarLocacoes.this, InseriFotoPonto.class);
                        GerenciarLocacoes.this.startActivity(intent);
                        finish();
                    }
                });
    ...
    private void confirmarDeletePoste(final String idMensagem) {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(this);
        alertDialogBuilder.setMessage("Tem certeza que deseja deletar este Poste?");

        alertDialogBuilder.setPositiveButton("Sim",
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface arg0, int arg1) {
                        excluiPoste(idMensagem);
                    }
                });
    ...
    private void confirmarDeletePonto(final String idMensagem) {
        ...
        alertDialogBuilder.setPositiveButton("Sim",
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface arg0, int arg1) {
                        deletarFotosPontos(idMensagem);
                        deletarEquipamento(idMensagem);
    ...
    private void deletarFotosPontos(final String idMens) {
        int idExcluido = Integer.parseInt(idMens.toString());
        db = openOrCreateDatabase(BANCO, Context.MODE_PRIVATE, null);
        db.execSQL("DELETE FROM " + TABELAFOTOSPOSTE + " WHERE IDPOSTE = " + idExcluido + "");
        db.close();
    }
    ...
    private void excluiPoste(final String idMens) {
        int idExcluido = Integer.parseInt(idMens.toString());
        db = openOrCreateDatabase(BANCO, Context.MODE_PRIVATE, null);
        db.execSQL("DELETE FROM " + TABELAPOSTE + " WHERE ID = " + idExcluido + "");

        db.execSQL("DELETE FROM " + TABELAFOTOSPOSTE + " WHERE IDPOSTE = " + idExcluido + "");
        db.execSQL("DELETE FROM " + TABELAESTRUTURA + " WHERE IDPOSTE = " + idExcluido + "");
        db.execSQL("DELETE FROM " + TABELAEQUIPAMENTO + " WHERE IDPOSTE = " + idExcluido + "");
        db.execSQL("DELETE FROM " + TABELACONSUMIDOR + " WHERE IDPOSTE = " + idExcluido + "");
        db.execSQL("DELETE FROM " + TABELACOORDENADAS + " WHERE IDPOSTE = " + idExcluido + "");
        ...
        if (linhas.moveToFirst()) {
            do {
                ...
                if (!linhas.getString(11).equals("")) {
                    ...
                    String iluminacaoPublica = String.format("%-3s", "-");
    ...
    private void createPdf() throws IOException, DocumentException {
        ...
        int contador = 1;
        String idPoste = "", conferiTexto = "", textoDadosEquipamento = "", id = "", texto2 = "";
        ...
        if (linhas.moveToFirst()) {
            ...
            do {
                ...
                if (linhas2.moveToFirst()) {
                    do {
                        if (!linhas.getString(11).equals("")) {
                            textoDadosEquipamento = " Descrição: " + linhas.getString(11);
                            texto2 =  " - Ponto.";
                        }else{


                            if (linhas2.getString(1).equals("") && linhas2.getString(2).equals("") && linhas2.getString(5).equals("") && linhas2.getString(6).equals("")) {
                                textoDadosEquipamento = " Não foram inseridos dados do Equipamento!";
                                texto2 =  " - PG: "+linhas.getString(4);
                                conferiTexto = "1";
                            } else {
                                String textoTransformador = "";
                                Log.d("antes entrou"," Transformador 10: "+linhas2.getString(1));
                                Log.d("antes entrou"," Transformador 20: "+linhas2.getString(5));
                                Log.d("antes entrou"," Transformador 30: "+linhas2.getString(6));
                                if(linhas2.getString(1).equals("Transformador")){
                                    textoTransformador = "\n  Potência do Transformador: " + linhas2.getString(5) + "\n  CIA: " + linhas2.getString(6) +" ";
                                    Log.d("entrou"," Transformador");
                                    Log.d("entrou"," Transformador 2: "+linhas2.getString(5));
                                    Log.d("entrou"," Transformador 3: "+linhas2.getString(6));
                                }
                                textoDadosEquipamento = "  Tipo de Equipamento: " + linhas2.getString(1) + "\n  Numero da Placa: " + linhas2.getString(2) + textoTransformador +"";
                                texto2 =  " - PG: "+linhas.getString(4);
                                conferiTexto = "0";
                            }
                        }
                        ...
                        if (linhas3.moveToFirst() && linhas3.getCount() > 0) {
                            ...
                            do {
                                ...
                                if (imagemBase64 != null) {
                                    ...
                                    Bitmap novoTamanho = Bitmap.createScaledBitmap(imagemBitmap, (int) (imagemBitmap.getWidth() * 0.49), (int) (imagemBitmap.getHeight() * 0.49), true);//tava 0.55
                                    novoTamanho.compress(Bitmap.CompressFormat.JPEG, 100, stream3);
                                    Image myImg3 = Image.getInstance(stream3.toByteArray());


                                    document.add(new Paragraph("  Poste: " + id +" "+texto2));
        ...
        if (linhas.moveToFirst()) { // Caso exista pelo menos uma imagem nesta locação
            ...
            do {
                ...
                if (imagemBase64 != null) {
                    ...
                    ByteArrayOutputStream stream3 = new ByteArrayOutputStream();
                    Bitmap imagemBitmap = decodeBase64(imagemBase64);
                    Bitmap novoTamanho = Bitmap.createScaledBitmap(imagemBitmap, (int) (imagemBitmap.getWidth() * 0.65), (int) (imagemBitmap.getHeight() * 0.65), true);// tava 0.71
                    novoTamanho.compress(Bitmap.CompressFormat.JPEG, 100, stream3);
                    Image myImg3 = Image.getInstance(stream3.toByteArray());
    ...
    private void inserirEquipamento(String id, String descricao) {

        db = openOrCreateDatabase(BANCO, Context.MODE_PRIVATE, null);
        ContentValues values = new ContentValues();
        values.put("TIPO", descricao);
        values.put("PLACA", "");
        values.put("IDPOSTE", id);

        db.insert(TABELAEQUIPAMENTO, null, values);
        db.close();
    }

    private void deletarEquipamento(final String idMens) {
        int idExcluido = Integer.parseInt(idMens.toString());
        db = openOrCreateDatabase(BANCO, Context.MODE_PRIVATE, null);
        db.execSQL("DELETE FROM " + TABELAEQUIPAMENTO + " WHERE IDPOSTE = " + idExcluido + "");
        db.close();
