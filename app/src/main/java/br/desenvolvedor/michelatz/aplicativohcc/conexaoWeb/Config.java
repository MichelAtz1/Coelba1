...
public class Config {
    ...
    //Servidor teste
    public static final String URL_ADD_IMAGEM = "http://aplicativohcc.16mb.com/dadosCoelba/inseriFotoServidor.php";
    public static final String URL_ADD_TXT = "http://aplicativohcc.16mb.com/dadosCoelba/inseriTxtServidor.php";
